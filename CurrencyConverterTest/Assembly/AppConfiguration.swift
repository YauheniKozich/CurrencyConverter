...
/// Конфигурация приложения, загружаемая из Config.plist
struct AppConfiguration {
    ...
    init() {
        ...
        guard let apiKey = config["CurrencyAPIKey"] as? String, !apiKey.isEmpty else {
        ...
        self.keychainService = config["KeychainService"] as? String ?? "com.yourapp.currencyconverter"
        self.keychainAccount = config["KeychainAccount"] as? String ?? "CurrencyAPIKey"
    }
